...
<div class="container">
	...
	<div class="card">
		...
		<p>
			The maximum number of sequences is set to 30 by default to keep the system
			running smoothly and to reduce waiting time.
			When too many sequences are selected, the analysis takes longer because the
			computer has to process more data.
			Limiting the number of sequences helps the system give results faster while
			still providing enough data for useful analysis.
		</p>
		...
		<p>
			...
			analyses, but their results will only be stored for the current browser session (i.e. until the brower is closed).
			For guest users, the system is set to refresh every 24 hours, meaning all previous searches will be removed. 
			Create an account and become part of the Protaylze family :)!
		</p>
